...
function compile_enum_p1(file_name, file_options, scope, param) {
  ...
  return type_of_spec(file_name, file_options, param.enum_id, scope, /* Enum */Block.__(0, [/* record */{
...
function compile_message_p1(file_name, file_options, message_scope, param) {
  ...
  var sub_scope = /* record */{
    packages: message_scope.packages,
    message_names: Pervasives.$at(message_scope.message_names, /* :: */[
          message_name,
          /* [] */0
        ])
  };
  ...
  return Pervasives.$at(match[2], /* :: */[
              type_of_spec(file_name, file_options, param.id, message_scope, /* Message */Block.__(1, [/* record */{
                        extensions: match[1],
                        message_name: message_name,
          ...
          switch (param.tag | 0) {
            case 0 :
                ...
                var field$1 = /* record */{
                  ...
                  field_type: compile_field_p2(field_name$1, field_type$1),
                  field_default: field.field_default,
                  field_options: field.field_options
                };
                var field$2 = /* record */{
                  field_parsed: field$1.field_parsed,
                  field_type: field$1.field_type,
                  field_default: compile_default_p2(types, field$1),
                  field_options: field$1.field_options
                };
                return /* :: */[
          ...
          return List.map((function (pbtt_msg) {
                        ...
                        if (match.tag) {
                                  ...
                                  switch (param$1.tag | 0) {
                                    case 0 :
                                        ...
                                        var record_field = /* record */{
                                          rf_label: label_name_of_field_name(field_name$1),
                                    ...
                                    case 1 :
                                        ...
                                        var record_field$1 = /* record */{
                                          rf_label: label_name_of_field_name(field$1.oneof_name),
                                          rf_field_type: /* Rft_variant_field */Block.__(4, [variant]),
                                          rf_mutable: false
                                        };
                                    ...
                                    case 2 :
                                        ...
                                        var record_field$2 = /* record */{
                                          ...
                                          rf_mutable: is_mutable(map_name, map_options)
                                        };
                                        return /* tuple */[
                                                variants,
                                                /* :: */[
                          ...
                          var record = /* record */{
                            ...
                            r_fields: List.rev(match$2[1])
                          };
                          var type_ = /* record */{
                            module_: module_,
                            spec: /* Record */Block.__(0, [record])
                          };
                          return List.rev(/* :: */[
                                      type_,
                                      match$2[0]
