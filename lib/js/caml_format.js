  ...
  switch (match) {
    case 0 :
        ...
        if (Caml_int64.lt(x$1, /* int64 */{
          ...
          s = String.fromCharCode(cvtbl.charCodeAt(modulus.lo | 0)) + s;
          ...
          s = String.fromCharCode(cvtbl.charCodeAt(modulus$1.lo | 0)) + s;
    ...
    case 2 :
        ...
        if (Caml_int64.lt(x$1, /* int64 */{
          ...
          s = String.fromCharCode(cvtbl$1.charCodeAt(modulus$2.lo | 0)) + s;
          ...
          s = String.fromCharCode(cvtbl$1.charCodeAt(modulus$3.lo | 0)) + s;
